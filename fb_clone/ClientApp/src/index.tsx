...
import { faBell, faBullhorn, faCamera, faCampground, faCaretDown, faCommentAlt, faEllipsisH, faFlag, faGamepad, faHandsHelping, faHeartbeat, faHome, faImages, faPencilAlt, faSearch, faShare, faSignOutAlt, faSmile, faStore, faTh, faThumbsUp, faTrashAlt, faTv, faUserFriends, faUsers, faUserTag } from '@fortawesome/free-solid-svg-icons';
...
library.add(fab, faHome, faTv, faStore, faUser, faUsers, faGamepad, faSearch, faTh, faBell, faCaretDown, faHeartbeat, faUserFriends, faFlag,
  ...
  faSignOutAlt, faEllipsisH, faPencilAlt, faTrashAlt, faCamera
);
